// import 'package:btms/Common/constants.dart';
import 'package:btms_member/Common/constants.dart';
...
mixin IApiHelper {
  ...
  /// Get 1 by Id from API [endpoint] using [uri] and [id]
  Future<Response> getById1<T>(String endpoint, String endpoint2, dynamic id,
      {Map<String, String> request = Constants.requestHeaders});
...
class ApiHelper extends GetConnect with IApiHelper {
  ...
  Future<Response> getById1<T>(String endpoint, String endpoint2, dynamic id,
      {Map<String, String>? request = Constants.requestHeaders}) {
    return get<T>('$endpoint$id' + '$endpoint2', headers: request);
  }
