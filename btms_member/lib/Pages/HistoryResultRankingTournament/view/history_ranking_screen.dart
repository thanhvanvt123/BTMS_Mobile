...
import 'package:btms_member/Pages/HistoryResultRankingTournament/controller/history_ranking_controller.dart';
...
class HistoryRankingScreen extends GetView<HistoryRankingController> {
  const HistoryRankingScreen({super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Obx(
                () {
                  var listRanking = controller.birdAchivement;
                  if (listRanking.isEmpty) {
                    return const Center(
                      child: Expanded(
                        child: Text(
                          style: TextStyle(fontSize: 18),
                          "Chưa có kết quả thi đấu. hãy chờ tới khi kết thúc giải đấu nhé !!!",
