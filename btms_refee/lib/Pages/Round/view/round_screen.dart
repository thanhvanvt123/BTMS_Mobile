                    ...
                    return Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext ctv, index) {
                          ...
                          if (round.status!.toUpperCase() == "END") {
                            return GestureDetector(
                              onTap: () {
                                // controller.goToDetail(bird.bird_Id);
                                // Get.toNamed(Routes.roundResult);
                                controller.goRoundResult2(
                                    round.round_Id, round.roundNumber);
                              },
                              child: Container(
                          ...
                          } else if (round.status!.toUpperCase() == "NONE") {
                            return GestureDetector(
                              onTap: () {
                                // controller.goToDetail(bird.bird_Id);
                                // Get.toNamed(Routes.roundResult);
                                // controller.goRoundResult(
                                //     round.round_Id, round.roundNumber);
                              },
                              child: Container(
                                height: screenSize.height * 0.15,
